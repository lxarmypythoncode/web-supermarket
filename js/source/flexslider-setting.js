jQuery( document ).ready(function($) {
	...
	$('.layer-slider').flexslider({
	    animation: supermarket_slider_value.supermarket_animation_effect,
	    animationLoop: true,
	    slideshow: true,
	    slideshowSpeed: supermarket_slider_value.supermarket_slideshowSpeed,
	    animationSpeed: supermarket_slider_value.supermarket_animationSpeed,
	    smoothHeight: true
	});
